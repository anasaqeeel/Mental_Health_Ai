    ...
    return (
        <div className="pallete-bg">
            ...
            <div className="card-grid">
                ...
                <PalleteCard title={"Psychometric Testing"} desc={"Psychology-based Counseling"} img={studentImg} url={"PT"} />
                <PalleteCard title={"Self-Report Testing"} desc={"Counseling based on Self-Assessments"} img={studentImg} url={"SRT"} />
            </div>
        </div>
    )
}
